import { ExternalLink, LayoutGrid, Radar, Settings, ShieldAlert } from 'lucide-react'
    ...
    <aside className="flex h-screen w-56 shrink-0 flex-col border-r border-border bg-surface">
      <div className="flex h-14 items-center gap-2 border-b border-border px-4">
        <svg viewBox="0 0 32 32" className="h-5 w-5" fill="none" aria-hidden="true">
          ...
          />
          <path d="M10 16.5l3.4 3.6L22 11" stroke="var(--color-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        <span className="font-display text-[15px] font-semibold tracking-tight text-text-primary">TraceGuard</span>
      </div>
